package com.serkowski.task6_4.config;
...
import com.serkowski.task6_4.service.VectorSyncAdvisor;
...
public class Configuration {
    ...
    @Bean
    public DialClient dialClient(ChatModel chatModel, VectorStore vectorStore, UserService userService, VectorStoreService vectorStoreService) {
                ...
                .defaultAdvisors(
                        ...
                        QuestionAnswerAdvisor.builder(vectorStore)
                                .searchRequest(SearchRequest.builder()
                                        ...
                                        .build())
                                .build(),
                        new VectorSyncAdvisor(vectorStoreService)
                )
