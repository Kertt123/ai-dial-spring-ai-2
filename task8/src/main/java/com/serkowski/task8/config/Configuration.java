package com.serkowski.task8.config;

import com.serkowski.task8.clients.DialClient;
import com.serkowski.task8.service.UserService;
import com.serkowski.task8.service.UserTools;
    ...
    public DialClient dialClient(ChatModel chatModel, UserService userService) {
        return new DialClient(ChatClient.builder(chatModel)
                ...
                .defaultOptions(AzureOpenAiChatOptions.builder()
                        ...
                        .build())
                .defaultTools(new UserTools(userService))
                .build());
    }
