package com.serkowski.task1;

import com.serkowski.task1.clients.DialCustomClient;
...
import static com.serkowski.task1.clients.Constants.DEFAULT_SYSTEM_PROMPT;

@SpringBootApplication(scanBasePackages = "com.serkowski.task1")
